...
public class AdminService extends GeneralService {
	...
	public List<Author> readAuthors(@RequestParam(value = "authorName", required = false) String authorName) {
		return readAuthorsGS(authorName);
	}

	@Transactional
	@RequestMapping(value = "/admin/readBooks", method = RequestMethod.GET, produces = "application/json")
	public List<Book> readBooks(@RequestParam(value = "title", required = false) String title) {
	...
	public List<LibraryBranch> readLibraryBranches(@RequestParam(value = "branchName", required = false) String branchName) {
		return readBranchesGS(branchName);
	}

	@Transactional
	@RequestMapping(value = "/admin/readGenres", method = RequestMethod.GET, produces = "application/json")
	public List<Genre> readGenres(@RequestParam(value = "genreName", required = false) String genreName) {
		return readGenresGS(genreName);
	}

	@Transactional
	@RequestMapping(value = "/admin/readBorrowers", method = RequestMethod.GET, produces = "application/json")
	public List<Borrower> readBorrowers(@RequestParam(value = "name", required = false) String name) {
		return readBorrowersGS(name);
	}

	@Transactional
	@RequestMapping(value = "/admin/readPublishers", method = RequestMethod.GET, produces = "application/json")
	public List<Publisher> readPublishers(@RequestParam(value = "publisherName", required = false) String publisherName) {
